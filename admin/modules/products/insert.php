...
<div class="insert-products" >
	...
	<tr>
		  <th>Sản phẩm:</th>
		<td><input type="text" name="name" placeholder="Tên sản phẩm" required autocomplete="off"> </td>
	</tr>
		<tr>
		<th>Giá:</th>
		<td><input type="text" name="price" placeholder="Giá sản phẩm" required autocomplete="off"></td>
		</tr>
		<tr>
		<th>Trạng thái:</th>
